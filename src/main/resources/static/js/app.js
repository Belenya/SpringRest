...
async function getPrincipal() {
    principal = await fetch("http://localhost:8080/api/admin/principal").then(response => response.json()).then(JSON.stringify).then(JSON.parse);
}

async function getRoles() {
    roles =  await fetch("http://localhost:8080/api/admin/roles").then(response => response.json()).then(JSON.stringify).then(JSON.parse);
}

async function getUsers() {
    users = await fetch("http://localhost:8080/api/admin").then(response => response.json()).then(JSON.stringify).then(JSON.parse);
}
